...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/explore` | `/explore` | `/(tabs)/` | `/(tabs)` | `/create-product` | `/modal`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/edit-product/${SingleRoutePart<T>}` | `/product-details/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/edit-product/[id]` | `/product-details/[id]`;
